...
We are a research group in the [National Institute of Physics](http://www.nip.upd.edu.ph), [University of the Philippines, Diliman](http://www.upd.edu.ph) (NIP-UPD). Founded in 2016, our overarching goal is to better understand gravity (and physical geometry, more generally) in all its facets, from Solar System scales to the vast reaches of the cosmos. We ponder questions in relativistic astrophysics, black hole physics, celestial dynamics, theoretical cosmology, and gravitational wave science. <!-- Anchored on core scientific values of <i>honesty</i>, <i>integrity</i>, <i> free expression</i>, <i>cooperation</i>, <i>curiosity</i> and <i>hard work</i>, Through these efforts, we hope to build a strong foundation for gravity and astrophysics research in this beautiful part of the world. --> In 2023, we became a founding member of the GANAP (Gravity, Astronomy, Nuclear and Particle Physics) Research Program of NIP-UPD.  
